...
import { githubLoginBegin, githubLoginPat, githubLoginPoll } from "@/github/auth/api";
import { classifyGithubDispatch, dispatchMessage } from "@/github/dispatch";
import { openUrl } from "@tauri-apps/plugin-opener";
import { cn } from "@/ui/cn";
import { btn, btnPrimary, fieldInput, fieldLabel } from "@/ui/ui";
...
export function GithubSignIn({ onSignedIn, onCancel }: Props) {
